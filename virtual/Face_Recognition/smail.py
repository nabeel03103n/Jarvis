...
face_file = "D:\\TEST\\haarcascade\\data\\haarcascades\\haarcascade_frontalface_default.xml"
eye_file = "D:\\TEST\\haarcascade\\data\\haarcascades\\haarcascade_eye.xml"
smile_file = "D:\\TEST\\haarcascade\\data\\haarcascades\\haarcascade_smile.xml"


cascade_face = cv2.CascadeClassifier(face_file) 
cascade_eye = cv2.CascadeClassifier(eye_file) 
cascade_smile = cv2.CascadeClassifier(smile_file)
...
def detection(grayscale, img):
    ...
    for (x_face, y_face, w_face, h_face) in face:
        ...
        for (x_smile, y_smile, w_smile, h_smile) in smile: 
            ...
            print("why are you smiling")
            speak("why are you smiling")
    return img 
