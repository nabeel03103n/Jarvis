...
while True:
    ...
    if hands:
        ...
        if len(hands) == 2:
            ...
            if  fingers1[1]==1:
                text = cv2.putText(img, str("Index Finger"), (50, 250), cv2.FONT_HERSHEY_PLAIN, 3, (255, 255, 8), 3)
 
                if fingers2[1]==1:
                    text = cv2.putText(img, str("Index Fingers"), (50, 250), cv2.FONT_HERSHEY_PLAIN, 3, (255, 255, 8), 3)
